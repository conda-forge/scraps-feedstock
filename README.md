...
Once the `conda-forge` channel has been enabled, `scraps` can be installed with:

```
conda install scraps
```

It is possible to list all of the versions of `scraps` available on your platform with:
